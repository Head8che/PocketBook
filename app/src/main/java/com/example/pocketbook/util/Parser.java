...
public class Parser {
     ...
     * @param requesters book requesters
     * @return
    ...
    public static Book parseBook(String id, String title, String author, String isbn, String owner,
                                 String status, boolean nonExchange, String comment,
                                 String condition, String photo, ArrayList<String> requesters) {
    ...
    /**
     * This checks if a book isbn is valid
     * @param isbn book isbn
     * @return
    ...
    /**
     * This checks whether or not a request object contains valid Request data
     * @param requestObject a request object containing Request data
     * @return
     *      true if the request object contains valid Request data
     *      false otherwise
     */
    ...
    /**
     * This checks if exchange data is valid
     * @param exchangeId exchange id
     * @param relatedBook related book
     * @param owner book owner
     * @param borrower book borrower
     * @param ownerBookStatus owner book status
     * @param borrowerBookStatus borrower book status
     * @param meetingDetails meeting details
     * @return
     *      true if exchange date is valid
     *      false otherwise
     */
    ...
    /**
     * This checks if meeting data is valid
    ...
    /**
     * This checks if meeting details is valid
     * @param meetingDetails meeting details
     * @return
     *      true if valid meeting details
     *      false otherwise
     */
    ...
    /**
     * This checks if a meeting date is valid
     * @param meetingDate date that a meeting was made
     * @return
     *      true if meeting date is valid
     *      false otherwise
     */
    ...
    /**
     * This checks if a meeting time is valid
     * @param meetingDate date that a meeting was made
     * @param meetingTime time that a meeting was made
     * @return
     *      true if meeting time is valid
     *      false otherwise
     */
